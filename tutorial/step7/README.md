...
| Body site    | `/items[…device_summary.v0]/data[at0001]/items[at0022]/items[at0010]`       | `DeviceUseStatement.device`   | 0..1        | Cluster                                   |
...
fhirconnect/ips/core/org/openehr/
  evaluation/device_summary.v0.yml                      # device_summary archetype mapping
fhirconnect/ips/core/org/openehr/
  cluster/device.v1.yml                      # device cluster archetype mapping
```
